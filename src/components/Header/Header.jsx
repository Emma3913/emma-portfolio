...
export const Header = () => {
  ...
  const handleDownload = () => {
    // TODO: Validar si ya se cambio el idioma para poner el curriculum en español o imgles depende jajaja
    ...
    <div className="h-[72px] bg-transparent backdrop-blur-xl px-4 flex items-center justify-between sticky top-0 z-20 ">
      <div className="flex items-center text-lg gap-4">
        <a
          ...
          target="_blank"
          rel="nofollow"
          href="https://www.linkedin.com/in/emmanuel-alexander-vaquero-aquino-24611a317/"
        >
          <svg
            stroke="currentColor"
            fill="currentColor"
        ...
        <a
          ...
          target="_blank"
          rel="nofollow"
          href="https://github.com/Emma3913"
        >
          <svg
            stroke="currentColor"
            fill="currentColor"
